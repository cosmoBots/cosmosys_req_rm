...
req_project_id_str = 'demo'					# The ID of the Redmine project where the requirements are stored.
req_cf_base = 0
...
if (cfg_homedir is None):
    cfg_homedir = os.getenv('HOMEDRIVE')+os.getenv("HOMEPATH")

# This is the location of the repository directory
cfg_repodir = None  #Redefine this
cfg_repodir = "E:\txinto\cvs\gitlab\reqs\\"

if cfg_repodir is None:
	cfg_repodir = cfg_homedir + "/repos/"
...
req_upload_file_name = cfg_repodir + req_project_id_str+"/uploading/RqUpload.ods"
req_download_file_name = cfg_repodir + req_project_id_str+"/downloading/RqDownload.ods"
...
reporting_dir = cfg_repodir + req_project_id_str + "/reporting"
...
dstop_root_path = cfg_repodir + req_project_id_str + "/doorstop"